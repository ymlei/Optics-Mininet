...
class OpticalSwitch : public Switch {
 public:
 ...
 public:
  ...
  explicit OpticalSwitch(bool enable_swap = false,
  ...
  OpticalSwitch(const OpticalSwitch &) = delete;
  OpticalSwitch &operator =(const OpticalSwitch &) = delete;
  OpticalSwitch(OpticalSwitch &&) = delete;
  OpticalSwitch &&operator =(OpticalSwitch &&) = delete;
