...
from oswitch_runtime import OpticalSwitch
from oswitch_runtime.ttypes import *
...
class OpticalSwitchAPI(runtime_CLI.RuntimeAPI):
    @staticmethod
    def get_thrift_services():
        return [("optical_switch", OpticalSwitch.Client)]
...
def main():
    ...
    services.extend(OpticalSwitchAPI.get_thrift_services())
    ...
    OpticalSwitchAPI(args.pre, standard_client, mc_client, sswitch_client).cmdloop()
