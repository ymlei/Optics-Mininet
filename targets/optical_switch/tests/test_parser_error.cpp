...
const char OpticalSwitch_ParserErrorP4::packet_in_addr[] =
    "inproc://packets";

OpticalSwitch *OpticalSwitch_ParserErrorP4::test_switch = nullptr;

const char OpticalSwitch_ParserErrorP4::testdata_dir[] = TESTDATADIR;
const char OpticalSwitch_ParserErrorP4::test_json[] = "parser_error.json";

TEST_F(OpticalSwitch_ParserErrorP4, NoError) {
...
TEST_F(OpticalSwitch_ParserErrorP4, PacketTooShort) {
  static constexpr int port = 1;
  int recv_port;
  char recv_buffer[kMaxBufSize];
...
TEST_F(OpticalSwitch_ParserErrorP4, CustomError) {
  static constexpr int port = 1;
  int recv_port;
  char recv_buffer[kMaxBufSize];
