...
const char OpticalSwitch_RecircP4::packet_in_addr[] =
    "inproc://packets";

OpticalSwitch *OpticalSwitch_RecircP4::test_switch = nullptr;

const char OpticalSwitch_RecircP4::testdata_dir[] = TESTDATADIR;
const char OpticalSwitch_RecircP4::test_json[] =
    "recirc.json";
...
TEST_F(OpticalSwitch_RecircP4, Recirc) {
