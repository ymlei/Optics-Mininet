...
class OpticalSwitch_SwapP4 : public ::testing::Test {
 protected:
  ...
  static void SetUpTestCase() {
    ...
    test_switch = new OpticalSwitch(true);  // with swapping
 ...
 private:
  ...
  static const char test_json_1[];
  static const char test_json_2[];
};

const char OpticalSwitch_SwapP4::packet_in_addr[] =
    "inproc://packets";

OpticalSwitch *OpticalSwitch_SwapP4::test_switch = nullptr;

const char OpticalSwitch_SwapP4::testdata_dir[] = TESTDATADIR;
const char OpticalSwitch_SwapP4::test_json_1[] = "swap_1.json";
const char OpticalSwitch_SwapP4::test_json_2[] = "swap_2.json";

TEST_F(OpticalSwitch_SwapP4, Swap) {
  const int port_in = 0;
  ...
  // OpticalSwitch is going to make the swap here
