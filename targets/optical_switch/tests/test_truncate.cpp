...
const char OpticalSwitch_TruncateP4::packet_in_addr[] =
    "inproc://packets";

OpticalSwitch *OpticalSwitch_TruncateP4::test_switch = nullptr;

const char OpticalSwitch_TruncateP4::testdata_dir[] = TESTDATADIR;
const char OpticalSwitch_TruncateP4::test_json[] =
    "truncate.json";

TEST_F(OpticalSwitch_TruncateP4, Truncate) {
