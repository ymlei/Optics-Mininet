...
packet_handler(int port_num, const char *buffer, int len, void *cookie) {
  static_cast<TorSwitch *>(cookie)->receive(port_num, buffer, len);
}

}  // namespace

class TorSwitch_PacketRedirectP4 : public ::testing::Test {
 protected:
  static constexpr size_t kMaxBufSize = 512;

  static constexpr bm::device_id_t device_id{0};

  TorSwitch_PacketRedirectP4()
  ...
  // the tor_switch target detaches threads
  static void SetUpTestCase() {
    ...
    test_switch = new TorSwitch(8);  // 8 ports
    ...
    test_switch->Switch::start();  // there is a start member in TorSwitch
  ...
  static std::string pid(packet_id_t copy_id) {
    return std::to_string(TorSwitch::get_packet_id()) + "." +
...
const char TorSwitch_PacketRedirectP4::event_logger_addr[] =
    "ipc:///tmp/test_events_abc123";
const char TorSwitch_PacketRedirectP4::packet_in_addr[] =
    "ipc:///tmp/test_packet_in_abc123";

TorSwitch *TorSwitch_PacketRedirectP4::test_switch = nullptr;

const char TorSwitch_PacketRedirectP4::testdata_dir[] = TESTDATADIR;
const char TorSwitch_PacketRedirectP4::test_json[] =
    "packet_redirect.json";

TEST_F(TorSwitch_PacketRedirectP4, Baseline) {
...
TEST_F(TorSwitch_PacketRedirectP4, Multicast) {
  static constexpr int port_in = 1;
  ...
  SCOPED_TRACE("TorSwitch_PacketRedirectP4.Multicast");
...
class TorSwitch_PacketRedirectP4_CloneI2E
    : public TorSwitch_PacketRedirectP4 {
 protected:
...
TEST_F(TorSwitch_PacketRedirectP4_CloneI2E, CloneI2E) {
  static constexpr int port_in = 1;
  static constexpr int port_out = 2;
  ...
  TorSwitch::MirroringSessionConfig config = {};
...
TEST_F(TorSwitch_PacketRedirectP4_CloneI2E, CloneI2E_Multicast) {
  static constexpr int port_in = 1;
  static constexpr int port_out = 2;
  static constexpr int port_out_copy = 3;
  ...
  auto pre = test_switch->get_component<McTorPreLAG>();
  SCOPED_TRACE("TorSwitch_PacketRedirectP4_CloneI2E.CloneI2E_Multicast");
...
class TorSwitch_PacketRedirectP4_CloneE2E
    : public TorSwitch_PacketRedirectP4 {
 protected:
  void add_entries(int port_out, int mirror_id) {
    std::vector<MatchKeyParam> match_key_1;
...
TEST_F(TorSwitch_PacketRedirectP4_CloneE2E, CloneE2E) {
  static constexpr int port_in = 1;
  static constexpr int port_out = 2;
  static constexpr int port_out_copy = 3;
  static constexpr int mirror_id = 1;
...
TEST_F(TorSwitch_PacketRedirectP4_CloneE2E, CloneE2E_Multicast) {
  static constexpr int port_in = 1;
  static constexpr int port_out = 2;
  static constexpr int port_out_copy = 3;
  static constexpr int port_out_mc_copy = 4;
  ...
  auto pre = test_switch->get_component<McTorPreLAG>();
  SCOPED_TRACE("TorSwitch_PacketRedirectP4_CloneE2E.CloneE2E_Multicast");
  PreTestConfiguration pre_config(pre.get(), mgrp, {port_out_mc_copy});
...
TEST_F(TorSwitch_PacketRedirectP4, Resubmit) {
  ...
  // should be the same? Update this if this changes in tor_switch
...
TEST_F(TorSwitch_PacketRedirectP4, Recirculate) {
  static constexpr int port_in = 1;
  static constexpr int port_out_1 = 2;
  static constexpr int port_out_2 = 3;
...
TEST_F(TorSwitch_PacketRedirectP4, ExitIngress) {
  static constexpr int port_in = 1;
