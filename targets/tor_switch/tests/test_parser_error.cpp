...
const char TorSwitch_ParserErrorP4::packet_in_addr[] =
    "inproc://packets";

TorSwitch *TorSwitch_ParserErrorP4::test_switch = nullptr;

const char TorSwitch_ParserErrorP4::testdata_dir[] = TESTDATADIR;
const char TorSwitch_ParserErrorP4::test_json[] = "parser_error.json";

TEST_F(TorSwitch_ParserErrorP4, NoError) {
...
TEST_F(TorSwitch_ParserErrorP4, PacketTooShort) {
  static constexpr int port = 1;
  int recv_port;
  char recv_buffer[kMaxBufSize];
...
TEST_F(TorSwitch_ParserErrorP4, CustomError) {
  static constexpr int port = 1;
  int recv_port;
  char recv_buffer[kMaxBufSize];
