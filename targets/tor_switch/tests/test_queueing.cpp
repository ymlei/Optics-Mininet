...
const char TorSwitch_QueueingP4::packet_in_addr[] =
    "inproc://packets";

TorSwitch *TorSwitch_QueueingP4::test_switch = nullptr;

const char TorSwitch_QueueingP4::testdata_dir[] = TESTDATADIR;
const char TorSwitch_QueueingP4::test_json[] =
    "queueing.json";

constexpr size_t TorSwitch_QueueingP4::kQueueingHdrSize;

TEST_F(TorSwitch_QueueingP4, QueueingBasic) {
...
TEST_F(TorSwitch_QueueingP4, QueueingAdvanced) {
  static constexpr int port_in = 1;
  static constexpr int port_out = 2;
  static constexpr size_t kPktSizeIn = 256u;
  static constexpr size_t kPktSizeOut = 256u + kQueueingHdrSize;
