...
class TorSwitch_RecircP4 : public ::testing::Test {
 protected:
...
const char TorSwitch_RecircP4::packet_in_addr[] =
    "inproc://packets";

TorSwitch *TorSwitch_RecircP4::test_switch = nullptr;

const char TorSwitch_RecircP4::testdata_dir[] = TESTDATADIR;
const char TorSwitch_RecircP4::test_json[] =
    "recirc.json";
...
TEST_F(TorSwitch_RecircP4, Recirc) {
