...
class TorSwitch_SwapP4 : public ::testing::Test {
 protected:
  ...
  static void SetUpTestCase() {
    ...
    test_switch = new TorSwitch(true);  // with swapping
...
const char TorSwitch_SwapP4::packet_in_addr[] =
    "inproc://packets";

TorSwitch *TorSwitch_SwapP4::test_switch = nullptr;

const char TorSwitch_SwapP4::testdata_dir[] = TESTDATADIR;
const char TorSwitch_SwapP4::test_json_1[] = "swap_1.json";
const char TorSwitch_SwapP4::test_json_2[] = "swap_2.json";

TEST_F(TorSwitch_SwapP4, Swap) {
  const int port_in = 0;
  ...
  // TorSwitch is going to make the swap here
