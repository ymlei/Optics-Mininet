...
const char TorSwitch_TruncateP4::packet_in_addr[] =
    "inproc://packets";

TorSwitch *TorSwitch_TruncateP4::test_switch = nullptr;

const char TorSwitch_TruncateP4::testdata_dir[] = TESTDATADIR;
const char TorSwitch_TruncateP4::test_json[] =
    "truncate.json";

TEST_F(TorSwitch_TruncateP4, Truncate) {
